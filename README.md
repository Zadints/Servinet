...
[![My Skills](https://skillicons.dev/icons?i=java,maven,javafx,sql)](https://skillicons.dev)
- **Java 21**
- **JavaFX 21**
- **Maven**
- **SQL Server**
...
- **CSS**
- **Ikonli**
- **Argon2** para el almacenamiento seguro de contraseñas
- **YAML** para la configuración de la aplicación
- **Clean Architecture**
